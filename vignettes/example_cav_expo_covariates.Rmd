---
title: "smms: analysing CAV data with simple exponential model, \\ with covariates"
output: 
  pdf_document:
    toc: true
    number_sections: true
vignette: >
  %\VignetteIndexEntry{smms: analysing CAV data with simple exponential model, with covariates}
...
Here we let the covariates influence all transition.
...
legend("bottomright",legend=c("youger donor, no IHD","youger donor, IHD",
                              "older donor, no IHD","older donor, IHD"),
       col=c("#0571b0","#ca0020","#0571b0","#ca0020"),lwd=2,bty="n",
       lty=c(1,1,2,2),cex=0.7)
