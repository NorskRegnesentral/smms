...
## Survival functions
S_01 = function(tt,param){1-pweibull(tt,param[1],param[2])}
S_12 = function(tt,param){1-pweibull(tt,param[3],param[4])}
S_23 = function(tt,param){1-pweibull(tt,param[5],param[6])}
S_03 = function(tt,param){1-pweibull(tt,param[7],param[8])}
S_13 = function(tt,param){1-pweibull(tt,param[9],param[10])}

## Density functions 
f_01 = function(tt,param){dweibull(tt,param[1],param[2])}
f_12 = function(tt,param){dweibull(tt,param[3],param[4])}
f_23 = function(tt,param){dweibull(tt,param[5],param[6])}
f_03 = function(tt,param){dweibull(tt,param[7],param[8])}
f_13 = function(tt,param){dweibull(tt,param[9],param[10])}
...
f01_f12_f23_S03_S13 = function(uu,ss,teval,param,teval2=NA){ # if T23 is not observed
...
int1 <- function(innerfunc,teval,param,tlim1,tlim2,tlim1_l2,tlim2_l2,teval2=NA){ #integrate over ss
  if (is.na(tlim1_l2)){
    ...
    out <- integrate(int2,innerfunc=innerfunc,lower=max(tlim1,0),upper=tlim2,teval=teval,param=param,
...
#lines(tval,S_01(tval,aa)*S_03(tval,aa),col="red")
