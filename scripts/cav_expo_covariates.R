...
p0_y0_ci <- occupancy_prob_ci_band("well",tval,mlo$par,gg,xval=c(-1,0),ho)
p0_y1_ci <- occupancy_prob_ci_band("well",tval,mlo$par,gg,xval=c(-1,1),ho)
p0_o0_ci <- occupancy_prob_ci_band("well",tval,mlo$par,gg,xval=c(1,0),ho)
p0_o1_ci <- occupancy_prob_ci_band("well",tval,mlo$par,gg,xval=c(1,1),ho)
p1_y0_ci <- occupancy_prob_ci_band("mild",tval,mlo$par,gg,xval=c(-1,0),ho)
p1_y1_ci <- occupancy_prob_ci_band("mild",tval,mlo$par,gg,xval=c(-1,1),ho)
p1_o0_ci <- occupancy_prob_ci_band("mild",tval,mlo$par,gg,xval=c(1,0),ho)
p1_o1_ci <- occupancy_prob_ci_band("mild",tval,mlo$par,gg,xval=c(1,1),ho)
p2_y0_ci <- occupancy_prob_ci_band("severe",tval,mlo$par,gg,xval=c(-1,0),ho)
p2_y1_ci <- occupancy_prob_ci_band("severe",tval,mlo$par,gg,xval=c(-1,1),ho)
p2_o0_ci <- occupancy_prob_ci_band("severe",tval,mlo$par,gg,xval=c(1,0),ho)
p2_o1_ci <- occupancy_prob_ci_band("severe",tval,mlo$par,gg,xval=c(1,1),ho)
p3_y0_ci <- occupancy_prob_ci_band("death",tval,mlo$par,gg,xval=c(-1,0),ho)
p3_y1_ci <- occupancy_prob_ci_band("death",tval,mlo$par,gg,xval=c(-1,1),ho)
p3_o0_ci <- occupancy_prob_ci_band("death",tval,mlo$par,gg,xval=c(1,0),ho)
p3_o1_ci <- occupancy_prob_ci_band("death",tval,mlo$par,gg,xval=c(1,1),ho)
