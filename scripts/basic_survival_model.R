...
par(mar=c(1,1,1,1))
plot(gg,layout=layout_with_sugiyama(gg,layers=c(1,2))$layout,vertex.size=20)
...
dd$state[dd$state==2] <- 1 #reducing to a single cause (just for this example)
