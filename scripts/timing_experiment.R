...
S_01 = function(param, x, t){ (1-pweibull(t,exp(param[1]),exp(param[2])))}
S_12 = function(param, x, t){ (1-pexp(t,exp(param[3])))}
S_23 = function(param, x, t){ (1-pexp(t,exp(param[4])))}
S_34 = function(param, x, t){ (1-pexp(t,exp(param[5])))}
S_45 = function(param, x, t){ (1-pexp(t,exp(param[6])))}
S_56 = function(param, x, t){ (1-pexp(t,exp(param[7])))}
...
S_01 = function(param, x, t){ (1-pweibull(t,exp(param[1]),exp(param[2])))}
S_12 = function(param, x, t){ (1-pweibull(t,exp(param[3]),exp(param[4])))}
S_23 = function(param, x, t){ (1-pweibull(t,exp(param[5]),exp(param[6])))}
S_34 = function(param, x, t){ (1-pweibull(t,exp(param[7]),exp(param[8])))}
S_45 = function(param, x, t){ (1-pweibull(t,exp(param[9]),exp(param[10])))}
S_56 = function(param, x, t){ (1-pweibull(t,exp(param[11]),exp(param[12])))}
