...
# FIX relationship between this function and the previous. TEST
# input a single observation type (and limits)which can consist of several formula types and limits)
occupancy_prob = function(time, param, method1 = "hcubature", integrand = integrand,integrand2 = integrand2, 
                                       all_integral_limits = all_integral_limits, X = NULL){
 #to do
}
